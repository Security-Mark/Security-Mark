...
def process_image(image_path, predictor_file, output_path, noise_strength=0.05, watermark_strength=150, offset=50, dct_strength=5, noise_intensity=2):
...
final_image = process_image(image_path, predictor_file, output_path)
